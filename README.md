...
Token is used for authentication, when a person sign up for a service they can be given a token and that is how they sign in to their partticullare saved data.
